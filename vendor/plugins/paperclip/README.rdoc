...
In your migrations:
  ...
  class AddAvatarColumnsToLogin < ActiveRecord::Migration
    def self.up
...
In your edit and new views:
  ...
  <% form_for :user, @login, :url => login_path, :html => { :multipart => true } do |form| %>
...
In your controller:
  ...
  def create
    @login = Login.create( params[:user] )
  end

In your show view:

  <%= image_tag @login.avatar.url %>
  <%= image_tag @login.avatar.url(:medium) %>
  <%= image_tag @login.avatar.url(:thumb) %>
