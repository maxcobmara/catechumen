class Staffsearch2 < ActiveRecord::Base
  ...
  def gra
    ...
    #Sokongan (2)
    return "staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=?" if position == 2
    #Pengurusan & Profesional (1)
    return "staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=? OR staffgrade_id=?" if position == 1
  end 
